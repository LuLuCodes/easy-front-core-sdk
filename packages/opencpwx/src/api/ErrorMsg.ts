export const ErrorMsg = {
  ...
  60104: '手机号码已存在，同一个企业内，成员的手机号不能重复',
  60105: '邮箱不合法，长度不超过64位，且为有效的email格式',
  60106: '邮箱已存在，同一个企业内，成员的邮箱不能重复。',
  ...
  60136: '记录不存在',
  60137: '家长手机号重复，同一个家校通讯录中，家长的手机号不能重复。',
  60203: '不合法的模版ID',
  60204: '模版状态不可用',
  60205: '模版关键词不匹配',
  ...
  65018: '家长人数达到上限，未验证的学校企业最多可添加2000名家长，验证过的学校企业最多可添加20000名家长',
  ...
  301014: '参数 english_name 不合法，不允许为空字符串，同时不能超过64字节，只能是由字母、数字、点(.)、减号(-)、空格或下划线(_)组成',
